...
RESPONSES: dict[str, tuple[str, ...]] = {
    ...
    "overplanning": (
        ...
        "Сначала не карта, а точка контакта с действием. {goal_line} Выбери один микро-действиe и запусти его. "
    ...
    "fatigue": (
        ...
        "Да, ресурс ниже. {goal_line} Сегодня не нужно марафониться — только символический вход: открой задачу и зафиксируй первый файл. ⛓️",
    ),
    "postpone": (
